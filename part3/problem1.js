  ...
  return new Promise(function (resolve, reject) {
    ...
    for (let i = 1; i <= 5; i++) {
      ...
      setTimeout(() => {
        ...
        console.log(`Step ini mendapatkan ${steps} langkah\n Sehingga langkahnya bertambah dari ${stepNow} menjadi ${(stepNow += steps)}`);
        if (counter === 5) {
          if (stepNow >= 30) {
            resolve(`Congratulations, you have passed this game! And your total step is ${stepNow}`);
          } else {
            reject(`Goodbye! you didn't passed this game because your step only ${stepNow}, because minimum step to pass in this game is ${shallPassed}`);
          }
        }
      }, time);
    }
